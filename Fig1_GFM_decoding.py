#%% 
# This script produces the results shown in Figure 1 of Wolff and Rademaker (2024)
# It loads the simulation data obtained from Fig1_GFM_simulations.m and performs the decoding analysis
